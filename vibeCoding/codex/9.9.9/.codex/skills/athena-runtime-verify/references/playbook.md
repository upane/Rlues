...
```bash
python3 ~/.agents/skills/athena-vm/scripts/runtime-run.py run --help
python3 ~/.agents/skills/athena-vm/scripts/runtime-run.py run --bundle <input.tar.gz> --contract <design.md> --scenario <scenario.json> --output <result.json> --runner local --requirement required --timeout 60
```
